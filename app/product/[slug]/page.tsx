          ...
          {features.length > 0 ? (
            <div className="grid gap-3 md:grid-cols-2">
              {features.map((feature: any, index: number) => (
                <div key={`${feature.title}-${index}`} className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-[32px] border border-amber-100 bg-white shadow-[0_25px_70px_rgba(15,23,42,0.08)]">
            ...
            <div className="space-y-3 p-6">
              ...
              <p className="text-sm text-slate-500">سيتم تحويلك للطلب المباشر من نفس هذه الصفحة.</p>
            </div>
          </div>
